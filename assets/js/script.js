...
function displayQuestion() {
    ...
    questAnswer1 = document.createElement("button");
    questAnswer2 = document.createElement("button");
    questAnswer3 = document.createElement("button");
    questAnswer4 = document.createElement("button");
